...
#define LOOM_ERR(fmt, ...)  fprintf(stderr, "\033[1;31merror:\033[0m " fmt "\n", ##__VA_ARGS__)
#define LOOM_WARN(fmt, ...) fprintf(stderr, "\033[1;33mwarn:\033[0m " fmt "\n", ##__VA_ARGS__)
#define LOOM_INFO(fmt, ...) fprintf(stderr, "\033[1;36minfo:\033[0m " fmt "\n", ##__VA_ARGS__)
#define LOOM_OK(fmt, ...)   fprintf(stderr, "\033[1;32m  ok:\033[0m " fmt "\n", ##__VA_ARGS__)
...
void loom_cache_update(const char *src, const char *flags, const char *cachedir);
